...
async function check() {
  console.log('--- Testando busca paralela com join ---');
  ...
  console.log(`Total de registros: ${count}. Disparando buscas em paralelo com join...`);
  ...
  console.log(`\nTempo total com join: ${Date.now() - start}ms`);
