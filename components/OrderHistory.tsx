      ...
      <div className="space-y-6 animate-in fade-in duration-300 pb-20">
        <div className="flex items-center justify-between no-print">
          ...
          <button 
            ...
            className={`flex items-center gap-2 font-black uppercase text-[10px] tracking-widest px-4 py-2 rounded-xl transition-all ${
              isSystemLocked ? 'text-gray-300 cursor-not-allowed' : 'text-red-500 hover:bg-red-50'
            }`}
          >
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0 ml-4 no-print relative z-20">
                   <button 
                     ...
                     className={`p-4 rounded-2xl transition-all border border-transparent shadow-sm ${
                        isSystemLocked ? 'text-gray-200 cursor-not-allowed' : 'text-gray-300 hover:text-red-600 hover:bg-red-50 hover:border-red-100'
                     }`}
