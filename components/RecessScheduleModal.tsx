...
const RecessScheduleModal: React.FC<RecessScheduleModalProps> = ({ isOpen, onClose, employees }) => {
  ...
  const handleSuggestActivities = async () => {
    ...
    try {
      ...
      const atividadesVigia = [
        "Controle rigoroso de entrada e saída pela portaria",
        "Ronda periódica noturna/diurna em todo o perímetro escolar",
        "Verificação do travamento de todas as portas e janelas",
        "Acompanhamento e registro de entrada de prestadores de serviços",
        "Acionamento e verificação do sistema de alarmes/câmeras",
        "Registro de ocorrências no livro de plantão"
      ];
      ...
      currentWorkingDays.forEach((day, index) => {
        ...
        const includeVigia = department === 'Todos' || department === 'Vigias';
        ...
        if (includeVigia) {
          const vig1 = atividadesVigia[(index * 2) % atividadesVigia.length];
          const vig2 = atividadesVigia[((index * 2) + 1) % atividadesVigia.length];
          text += `VIGIAS / SEGURANÇA:\n- ${vig1}\n- ${vig2}\n\n`;
        }
              ...
              <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-6">
                ...
                <div className="border border-purple-200 bg-purple-50 rounded-xl p-4">
                  ...
                  >
                    ...
                    <option value="Vigias">Apenas Vigias</option>
                  </select>
                    ...
                    <div key={schedule.id} className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
                      ...
                      <div className="hidden">
                        <div id={`print-recess-${schedule.id}`} className="p-8 bg-white text-gray-900 font-sans">
                          <div className="flex justify-between items-center border-b-2 border-gray-900 pb-2 mb-4 gap-4">
                            <div className="flex items-center justify-start flex-1">
                              <img src="/logo-escola-oficial.png" alt="Escola Logo" className="h-16 w-auto object-contain" />
                            </div>
                            <div className="flex-[2] flex justify-center px-4">
                              <img src="/dados escola.jpeg" alt="Dados da Escola" className="h-16 w-full object-contain" />
                            </div>
                          ...
                          <div className="text-center mb-6">
                            <h3 className="text-base font-black uppercase mt-1 inline-block px-4 py-1 rounded border border-gray-300 bg-gray-50">
                              Escala de Trabalho - Recesso
