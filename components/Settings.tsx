...
const ROLES_LIST = [
  ...
  { id: 'SECRETARIA', label: 'Apoio (Secretaria)' },
  { id: 'PSICOSSOCIAL', label: 'Técnico (Equipe Multi)' },
];
...
const Settings: React.FC = () => {
  ...
  const [permissions, setPermissions] = useState<Record<string, string[]>>(() => {
    ...
    return saved ? JSON.parse(saved) : {
      ...
      'SECRETARIA': ['secretariat', 'merenda', 'finance', 'busca_ativa', 'pedagogical', 'scheduling', 'library', 'patrimonio', 'limpeza'],
      'PSICOSSOCIAL': ['psychosocial', 'busca_ativa', 'scheduling']
    };
  });
