...
const AuditoriumScheduler: React.FC = () => {
   ...
   const handleAddBooking = async (e: React.FormEvent) => {
      ...
      try {
         ...
         setNewBooking({ ...newBooking, classes: [], teacherName: '', className: '', eventName: '', eventType: 'Palestra', needsSound: false, needsProjector: false, needsAc: true, observations: '' });
