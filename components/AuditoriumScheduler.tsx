...
import { AuditoriumBooking, Shift, StaffMember, User } from '../types';
...
interface AuditoriumSchedulerProps {
   user?: User;
}
...
const AuditoriumScheduler: React.FC<AuditoriumSchedulerProps> = ({ user }) => {
   ...
   const deleteBooking = async (
      ...
      const confirmMsg = teacherName
         ? `Deseja realmente CANCELAR o agendamento de:\n\n👤 ${teacherName}\n🎭 ${details}\n\nO auditório ficará imediatamente disponível no sistema.`
         : "Deseja cancelar esta reserva do auditório?";
      ...
      <div className="space-y-8 animate-in fade-in duration-500">
         ...
         <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm overflow-hidden">
            <div className="flex items-center gap-3 mb-8 border-b border-gray-50 pb-6">
               ...
               <h4 className="text-lg font-black text-gray-900 uppercase tracking-tight">Disponibilidade: {selectedDate.split('-').reverse().join('/')}</h4>
            </div>
                     ...
                     <div className="px-10 pt-10 pb-6 flex justify-between items-center">
                        <div className="flex items-center gap-4">
                           ...
                           <div>
                              ...
                              <p className="text-[10px] text-emerald-400 font-bold uppercase tracking-widest mt-1">Data do Evento: {selectedDate.split('-').reverse().join('/')}</p>
                           </div>
                        </div>
