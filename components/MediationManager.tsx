...
Outputs:
Outputs:
Wait... Tab button logic was slightly duplicated or had weird nesting. I will fix it in a single replace. The previous replace might have been half-successful. I will try a cleaner contiguous replacement for the whole tab area.
Before that, I'll update the counts too.
Actually, I already updated the counts. I'll just fix the UI.
               </div>
            </div>
         </div>
