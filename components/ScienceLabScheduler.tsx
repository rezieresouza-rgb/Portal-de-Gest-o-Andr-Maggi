  ...
  const handleAddBooking = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from('bookings').insert([{
        ...
        title: `[${newBooking.subject}] ${newBooking.experimentName}`,
      ...
      setNewBooking({ ...newBooking, classes: [], teacherName: '', className: '', subject: '', experimentName: '', needsTechnician: false, observations: '' });
              ...
              <div className="px-10 pt-10 pb-6 flex justify-between items-center shrink-0 border-b border-gray-50">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-emerald-400 font-bold uppercase tracking-widest mt-1">Data: {selectedDate.split('-').reverse().join('/')}</p>
                  </div>
                </div>
