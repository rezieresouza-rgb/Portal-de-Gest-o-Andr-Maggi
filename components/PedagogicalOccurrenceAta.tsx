           ...
           <div id="printable-area" className="bg-white p-12 md:p-16 rounded-[3rem] border-2 border-violet-100 shadow-2xl space-y-12">
              <div ref={printRef} className="space-y-12 text-gray-900 font-sans pdf-export-view">
                 ...
                 <div className="text-center border-b-2 border-black pb-8 space-y-2">
                    <h1 className="text-2xl font-black uppercase tracking-tight">Ata de Ocorrência Escolar</h1>
                    <p className="text-sm font-bold uppercase">Escola Estadual André Antônio Maggi | Unidade Colíder-MT</p>
                    <p className="text-[10px] font-bold text-gray-500">Secretaria de Estado de Educação de Mato Grosso</p>
                 </div>
