...
export interface ScienceLabBooking { id: string; date: string; shift: Shift; classes: string[]; teacherName: string; className: string; experimentName: string; needsTechnician: boolean; observations: string; timestamp: number; }
export interface PedagogicalKitchenBooking { id: string; date: string; shift: Shift; classes: string[]; teacherName: string; className: string; projectName: string; ingredientsRequested: string; observations: string; timestamp: number; }
export interface LibraryRoomBooking { id: string; date: string; shift: Shift; classes: string[]; teacherName: string; className: string; activityType: 'Leitura Livre' | 'Pesquisa Orientada' | 'Contação de Histórias' | 'Exposição' | 'Outros'; needsMediaProjector: boolean; observations: string; timestamp: number; }
export interface MakerLabBooking { id: string; date: string; shift: Shift; classes: string[]; teacherName: string; className: string; projectName: string; equipmentUsed: string[]; observations: string; timestamp: number; }
export interface AuditoriumBooking { id: string; date: string; shift: Shift; classes: string[]; teacherName: string; className: string; eventName: string; eventType: 'Palestra' | 'Apresentação' | 'Cinema' | 'Ensaio' | 'Reunião' | 'Outros'; needsSound: boolean; needsProjector: boolean; needsAc: boolean; observations: string; timestamp: number; }
...
export interface LessonPlanRow { weekOrDate: string; content: string; activities: string; methodology: string; evaluation: string; }
export interface LessonPlan { id: string; bimestre: string; subject: string; teacher: string; year: string; className: string; weeklyClasses: string; skills: PedagogicalSkill[]; recompositionSkills: PedagogicalSkill[]; themes: string; rows: LessonPlanRow[]; status: 'RASCUNHO' | 'EM_ANALISE' | 'VALIDADO' | 'CORRECAO_SOLICITADA'; coordinationFeedback?: string; timestamp: number; }
