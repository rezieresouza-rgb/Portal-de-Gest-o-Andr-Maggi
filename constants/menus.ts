...
export const OFFICIAL_MENUS: WeeklyMenu[] = [
  {
    ...
    label: "1ª SEMANA",
    days: [
      { day: "Segunda", dish: "SALADA DE ALFACE COM TOMATE, MACARRÃO COM MOLHO DE CARNE MOÍDA + ABACAXI", ingredients: ["ALFACE", "ALHO", "CARNE MOIDA", "CEBOLA", "MACARRÃO", "EXTRATO DE TOMATE", "TOMATE", "ABACAXI", "SALSA", "PIMENTÃO VERDE"] },
      { day: "Terça", dish: "FRICASSÊ DE FRANGO COM ABÓBORA E ARROZ + PÃO COM QUEIJO MUSSARELA E SUCO DE POLPA DE FRUTA", ingredients: ["FRANGO", "ABÓBORA", "ARROZ", "AMIDO DE MILHO", "LEITE", "QUEIJO MUSSARELA", "PÃO FRANCÊS", "POLPA DE FRUTA", "PIMENTÃO VERDE", "AÇÚCAR CRISTAL"] },
      { day: "Quarta", dish: "SALADA DE REPOLHO COM COUVE, ARROZ COM CARNE SUÍNA E FEIJÃO + BANANA", ingredients: ["REPOLHO", "CARNE SUÍNA", "FEIJÃO CARIOCA", "ARROZ BRANCO", "BANANA", "COUVE", "SALSA"] },
      { day: "Quinta", dish: "ESTROGONOFE DE CARNE E ARROZ + BOLO DE CHOCOLATE E CHÁ", ingredients: ["CARNE BOVINA ISCAS", "ARROZ BRANCO", "LEITE", "EXTRATO DE TOMATE", "FARINHA DE TRIGO", "CACAU EM PÓ", "CHÁ MATE", "OVO DE GALINHA", "FERMENTO QUÍMICO", "SALSA", "AÇÚCAR CRISTAL"] },
      { day: "Sexta", dish: "FRANGO AO MOLHO COM BATATA E CENOURA, ARROZ, FEIJÃO + MELÃO", ingredients: ["FILÉ DE PEITO DE FRANGO", "BATATA INGLESA", "CENOURA", "ARROZ BRANCO", "FEIJÃO CARIOCA", "MELÃO", "SALSA", "PIMENTÃO VERDE"] }
    ]
  },
  {
    week: 2,
