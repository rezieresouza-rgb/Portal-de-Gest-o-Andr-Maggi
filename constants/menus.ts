...
export const OFFICIAL_MENUS: WeeklyMenu[] = [
  {
    ...
    days: [
      ...
      { day: "Quinta", dish: "ESTROGONOFE DE CARNE E ARROZ + BOLO DE CHOCOLATE E CHÁ", ingredients: ["CARNE EM ISCAS", "ARROZ BRANCO", "LEITE", "EXTRATO DE TOMATE", "FARINHA DE TRIGO", "CACAU EM PÓ", "CHÁ MATE", "OVO DE GALINHA", "FERMENTO QUÍMICO", "SALSA", "AÇÚCAR"] },
