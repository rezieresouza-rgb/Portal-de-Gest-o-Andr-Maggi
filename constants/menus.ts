...
export const OFFICIAL_MENUS: WeeklyMenu[] = [
  {
    ...
    days: [
      ...
      { day: "Terça", dish: "FRICASSÊ DE FRANGO COM ABÓBORA E ARROZ + PÃO COM QUEIJO MUSSARELA E SUCO DE POLPA DE FRUTA", ingredients: ["FRANGO", "ABÓBORA", "ARROZ", "AMIDO DE MILHO", "LEITE", "QUEIJO MUSSARELA", "PÃO FRANCÊS", "POLPA DE FRUTA", "PIMENTÃO VERDE", "AÇÚCAR"] },
      ...
      { day: "Quinta", dish: "ESTROGONOFE DE CARNE E ARROZ + BOLO DE CHOCOLATE E CHÁ", ingredients: ["CARNE BOVINA ISCAS", "ARROZ BRANCO", "LEITE", "EXTRATO DE TOMATE", "FARINHA DE TRIGO", "CACAU EM PÓ", "CHÁ MATE", "OVO DE GALINHA", "FERMENTO QUÍMICO", "SALSA", "AÇÚCAR"] },
