...
async function resetContract002() {
    console.log('Iniciando limpeza e reset de saldos exclusivamente para os contratos contendo 002/2026...');
    ...
    try {
        ...
        if (errC || !contracts || contracts.length === 0) {
            console.error('Nenhum contrato 002/2026 encontrado:', errC);
            return;
        }

        console.log(`Encontrados ${contracts.length} contratos correspondentes a 002/2026. Processando...`);
